...
out.println(" <input id='id12' class='class3' type='text' name='sName' size='20' maxlenght'50' value='" +
sName +" '/>");%></div>
...
<div id="div4">
<footer><p>&copy; 2020 Made by Korea. All rights reserved.</p></footer></body></html>
